import { normalizeProvince, provinceFromText } from "./location.js";
...
export function enrichCarOffer(offer, spec) {
  ...
  const province = normalizeProvince(offer.province)
    || extractProvince(offer.province)
    || extractProvince(offer.location)
    || extractProvince(combined);
